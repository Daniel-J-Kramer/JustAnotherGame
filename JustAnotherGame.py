...
while (choice < 1) or (choice > 5):
    ...
    time.sleep(1)
    textWriter.textWriter(choices.choiceone[0], delay)
    time.sleep(.5)
    textWriter.textWriter(choices.choiceone[1], delay)
    time.sleep(.5)
    textWriter.textWriter(choices.choiceone[2], delay)
    time.sleep(.5)
    textWriter.textWriter(choices.choiceone[3], delay)
    time.sleep(.5)
    textWriter.textWriter(choices.choiceone[4], delay)
    time.sleep(.25)
